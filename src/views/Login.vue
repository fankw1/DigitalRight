            ...
            <div id="login">
                <span>
                    <form action="post">
                        ...
                        <input type="button" value="log in" class="btn" @click="checkLogin" style="margin-right: 20px;">
                    </form>
                    <a href="#">！请安装先Metamask进行登录</a>
                </span>
            </div>
